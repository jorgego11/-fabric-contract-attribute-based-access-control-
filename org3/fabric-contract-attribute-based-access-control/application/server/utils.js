...
utils.registerUser = async (userid, userpwd, usertype, adminIdentity, affiliationIn) => {
    console.log("\n------------  utils.registerUser ---------------");
    console.log("\n userid: " + userid + ", pwd: " + userpwd + ", usertype: " + usertype + ", affiliation: " + affiliationIn)
...
utils.enrollUser = async (userid, userpwd, usertype) => {
    ...
    return ca.enroll(newUserDetails).then(enrollment => {
        ...
        //var identity = X509WalletMixin.createIdentity('ABFarmmsp', enrollment.certificate, enrollment.key.toBytes());
